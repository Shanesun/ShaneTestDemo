...
- (IBAction)encryptoButtonClicked:(id)sender
{
    ...
    NSString *str = [[NSBundle mainBundle] pathForResource:@"1.zip" ofType:nil];
    self.cryptoImageData = [NSData dataWithContentsOfFile:str];
   NSData *newData = [self.cryptoImageData AES128DecryptWithKey:AES];
    NSTimeInterval now = CACurrentMediaTime();
